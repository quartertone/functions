...
TODO FIXME: - gridcal is showmonth wrapped in promise, with dimbg
- put monthgrid inside showmonth
...
customElements.define("grid-cal", class GridCalendar extends HTMLElement {
  ...
  constructor() {
    ...
    function gridcalendar() {
      ...
      showmonth({refdate:basethis.value,anchor:calendarbox, classes:"floatingcal"});
